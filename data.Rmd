...
povplot <- ggplot() +
  geom_point(data = pov_status_final, aes(x = whitepov, y = whitedo), col = "red") +
  geom_smooth(data = pov_status_final, aes(x = whitepov, y = whitedo), method = "lm", se = F, col = "red") +
  geom_point(data = pov_status_final1, aes(x = blackpov, y = blackdo), col = "green") +
  geom_smooth(data = pov_status_final1, aes(x = blackpov, y = blackdo), method = "lm", se = F, col = "green") +
  geom_point(data = pov_status_final2, aes(x = asianpov, y = asiando), col = "blue") +
  geom_smooth(data = pov_status_final2, aes(x = asianpov, y = asiando), method = "lm", se = F, col = "blue") +
  geom_point(data = pov_status_final3, aes(x = hisppov, y = hispdo), col = "orange") +
  geom_smooth(data = pov_status_final3, aes(x = hisppov, y = hispdo), method = "lm", se = F, col = "orange") +
...
povplot
plot.new()
legend("bottomleft", legend = c("White", "Black", "Asian", "Hispanic"),
       col = c("red", "green", "blue", "orange"), lty = 1:2, cex = 0.8,
       title = "Race", text.font = 4, bg = "lightblue")
```
